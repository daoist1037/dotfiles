...
if [[ $ANTIGEN_CACHE != false ]]; then
  ANTIGEN_CACHE="${ANTIGEN_CACHE:-${ADOTDIR:-$HOME/dotfiles/zsh/.antigen}/init.zsh}"
  ANTIGEN_RSRC="${ANTIGEN_RSRC:-${ADOTDIR:-$HOME/dotfiles/zsh/.antigen}/.resources}"
...
-antigen-env-setup () {
  ...
  -antigen-set-default ADOTDIR $HOME/dotfiles/zsh/.antigen
...
ANTIGEN_DEBUG_LOG=${ANTIGEN_DEBUG_LOG:-${ADOTDIR:-$HOME/dotfiles/zsh/.antigen}/debug.log}
LOG () {
