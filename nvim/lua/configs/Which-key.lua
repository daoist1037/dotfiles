return function()
    ...
    whick_key.register({
        ...
        -- ["<leader>pi"] = { "<Cmd>PackerMagicCompile<CR><Cmd>PackerInstall<CR>", "PackerInstall" },
        ["<leader>pc"] = { "<Cmd>PackerMagicCompile<CR>", "PackerMagicCompile" },
        -- ["<leader>pC"] = { "<Cmd>PackerMagicCompile<CR><Cmd>PackerClean<CR>", "PackerClean" },
        -- ["<leader>pS"] = { "<Cmd>PackerMagicCompile<CR><Cmd>PackerStatus<CR>", "PackerStatus" },
        ["<leader>ps"] = { "<Cmd>PackerMagicSync<CR>", "PackerMagicSync" },
        -- ["<leader>pu"] = { "<Cmd>PackerMagicCompile<CR><Cmd>PackerUpdate<CR>", "PackerUpdate" },
