return function()
    ...
    whick_key.register({
        ...
        ["<leader>fe"] = { "<cmd>edit ~/dotfiles/nvim/lua/core/init.lua<cr>", "Edit init.lua" },
        ...
        ["<leader>pi"] = { "<Cmd>lua require('packer').install()<CR>", "PackerInstall" },
        ["<leader>pc"] = { "<Cmd>lua require('core.pack').magic_compile()<CR>", "PackerCompile" },
        ["<leader>pC"] = { "<Cmd>lua require('packer').clean()<CR>", "PackerClean" },
        ["<leader>ps"] = { "<Cmd>lua require('core.pack').magic_compile() require('packer').status()<CR>", "PackerStatus" },
        ["<leader>pS"] = { "<Cmd>lua require('core.pack').magic_sync()<CR>", "PackerSync" },
        ["<leader>pu"] = { "<Cmd>lua require('packer').update()<CR>", "PackerUpdate" },
