return function()
    ...
    whick_key.register({
        ...
        ["<F2>"] = { "<cmd>lua require'core.mappings'.yabstask('run')<CR>", "yabs run" },
        ["<F3>"] = { "<cmd>lua require'core.mappings'.yabstask('build')<CR>", "yabs build" },
        ["<F4>"] = { "<cmd>lua require'core.mappings'.dapui()<CR>", "dapui toggle" },
        ["<F5>"] = { "<cmd>lua require'core.mappings'.dap('continue')<CR>", "dap continue" },
        ["<F9>"] = { "<cmd>lua require'core.mappings'.dap('toggle_breakpoint')<CR>", "dap breakpoints" },
        ["<F10>"] = { "<cmd>lua require'core.mappings'.dap('step_over')<CR>", "dap stepover" },
        ["<F8>"] = { "<cmd>lua require'core.mappings'.dap('step_into')<CR>", "dap stepinto" },
        ["<F12>"] = { "<cmd>lua require'core.mappings'.dap('disconnect')<CR><cmd>lua require'core.mappings'.dap('close')<CR>", "dap close" },
        ...
        ["<leader>bh"] = { "<cmd>lua require'core.mappings'.bdelete('hidden')<CR>", "hidden" },
        ["<leader>bu"] = { "<cmd>lua require'core.mappings'.bdelete('nameless')<CR>", "nameless" },
        ["<leader>bc"] = { "<cmd>lua require'core.mappings'.bdelete('this')<CR>", "this" },
...
-- ["<leader>bh"] = { "<cmd>lua require('close_buffers').delete({type = 'hidden'})<CR>", "hidden" },
-- ["<leader>bu"] = { "<cmd>lua require('close_buffers').delete({type = 'nameless'})<CR>", "nameless" },
-- ["<leader>bc"] = { "<cmd>lua require('close_buffers').delete({type = 'this'})<CR>", "this" },
-- ["<F2>"] = { "<cmd>YabsTask run<CR>", "yabs run" },
-- ["<F3>"] = { "<cmd>YabsTask build<CR>", "yabs build" },
-- ["<F4>"] = { "<cmd>lua require'dapui'.toggle()<CR>", "dapui toggle" },
-- ["<F5>"] = { "<cmd>lua require'dap'.continue()<CR>", "dap continue" },
-- ["<F9>"] = { "<cmd>lua require'dap'.toggle_breakpoint()<CR>", "dap breakpoints" },
-- ["<F10>"] = { "<cmd>lua require'dap'.step_over()<CR>", "dap step_over" },
-- ["<F11>"] = { "<cmd>lua require'dap'.step_into()<CR>", "dap step_into" },
-- ["<F12>"] = { "<cmd>lua require'dap'.disconnect()<CR><cmd>lua require'dap'.close()<CR>", "dap close" },
