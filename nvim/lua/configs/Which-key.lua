return function()
    ...
    whick_key.register({
        ...
        ["<leader>bd"] = { name = "BDelete" },
        ["<leader>bdh"] = { "<cmd>lua require('close_buffers').delete({type = 'hidden'})<CR>", "hidden" },
        ["<leader>bdu"] = { "<cmd>lua require('close_buffers').delete({type = 'nameless'})<CR>", "nameless" },
        ["<leader>bdc"] = { "<cmd>lua require('close_buffers').delete({type = 'this'})<CR>", "this" },
        -- ["<leader>bdt"] = { "<cmd>lua require('close_buffers').delete({ regex = '.*codelldb.*' })<CR>", "codelldb" },
