...
_G.packer_plugins = {
  ...
  ["kanagawa.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/daoist/.local/share/nvim/site/pack/packer/opt/kanagawa.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-nvim-lsp", "nvim-autopairs", "cmp-nvim-lua", "cmp-look", "cmp-cmdline", "LuaSnip", "cmp-buffer", "cmp-path", "cmp-nvim-lsp-document-symbol" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-installer", "symbols-outline.nvim", "nvim-dap", "lspsaga.nvim", "formatter.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "completion-treesitter", "nvim-treesitter-textobjects", "playground" },
  ...
  ["telescope.nvim"] = {
    commands = { "Telescope" },
    config = { "\27LJ\1\2Ý\1\0\0\5\0\f\0\0174\0\0\0%\1\1\0>\0\2\0027\1\2\0003\2\4\0003\3\3\0:\3\5\0023\3\a\0003\4\6\0:\4\b\0032\4\0\0:\4\t\0032\4\0\0:\4\n\3:\3\v\2>\1\2\1G\0\1\0\fpickers\14live_grep\roldfiles\15find_files\1\0\0\1\0\2\vhidden\2\14no_ignore\2\rdefaults\1\0\0\1\0\2\18prompt_prefix\v ï€‚  \26dynamic_preview_title\2\nsetup\14telescope\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'surround.nvim', 'nvim-treesitter', 'indent-blankline.nvim', 'nvim-web-devicons', 'accelerated-jk', 'gitsigns.nvim', 'bufferline.nvim', 'lualine.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
